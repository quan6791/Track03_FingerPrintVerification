...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul  2 15:44:12 2018
...
fp = sorted(glob('../data_set/training_output_02/*.jpg'))
model = Model()
...
try:
    makedirs('../data_set/training_output_03')
...
#     print x.shape
    ...
    y_hat.save('../data_set/training_output_03/{}'.format(split(fp[i])[1])) # *contents* of the validation_output directory
