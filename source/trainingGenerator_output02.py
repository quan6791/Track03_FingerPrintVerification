...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul  2 15:35:33 2018
...
fp = sorted(glob('../data_set/training_output/*.jpg'))
model = Model()
...
if device >= 0:
    model.to_gpu(device)
try:
    makedirs('../data_set/training_output_02')
...
#     print x.shape
    ...
    y_hat.save('../data_set/training_output_02/{}'.format(split(fp[i])[1])) # *contents* of the validation_output directory
