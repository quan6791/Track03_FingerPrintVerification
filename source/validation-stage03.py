...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul  2 15:52:57 2018
...
fp = sorted(glob('../data_set/validation_output_02/*.jpg'))
model = Model()

load_npz('../model_step03.npz', model)

if device >= 0:
    model.to_gpu(device)
try:
    makedirs('../data_set/validation_output_03')
...
#     print x.shape
    ...
    y_hat.save('../data_set/validation_output_03/{}'.format(split(fp[i])[1])) # *contents* of the validation_output directory
