...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul  2 15:56:42 2018
...
fp = sorted(glob('../data_set/validation_output_06/*.jpg'))
model = Model()

load_npz('../model_step07.npz', model)

if device >= 0:
    model.to_gpu(device)
try:
    makedirs('../data_set/validation_output_07')
...
#     print x.shape
    ...
    y_hat.save('../data_set/validation_output_07/{}'.format(split(fp[i])[1])) # *contents* of the validation_output directory
