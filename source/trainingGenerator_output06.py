...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul  2 15:48:38 2018
...
fp = sorted(glob('../data_set/training_output_05/*.jpg'))
model = Model()
...
if device >= 0:
    model.to_gpu(device)
try:
    makedirs('../data_set/training_output_06')
...
#     print x.shape
    ...
    y_hat.save('../data_set/training_output_06/{}'.format(split(fp[i])[1])) # *contents* of the validation_output directory
