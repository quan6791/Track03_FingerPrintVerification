...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul  2 15:54:41 2018
...
fp = sorted(glob('../data_set/validation_output_04/*.jpg'))
model = Model()
...
try:
    makedirs('../data_set/validation_output_05')
...
#     print x.shape
    ...
    y_hat.save('../data_set/validation_output_05/{}'.format(split(fp[i])[1])) # *contents* of the validation_output directory
