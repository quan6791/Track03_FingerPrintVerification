...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul  2 15:55:26 2018
...
fp = sorted(glob('../data_set/validation_output_05/*.jpg'))
model = Model()

load_npz('../model_step06.npz', model)

if device >= 0:
    model.to_gpu(device)
try:
    makedirs('../data_set/validation_output_06')
...
#     print x.shape
    ...
    y_hat.save('../data_set/validation_output_06/{}'.format(split(fp[i])[1])) # *contents* of the validation_output directory
